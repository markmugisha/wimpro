...
import { updateQaData } from '../../../api/client';
...
function EditAssessed({ row, onSubmit }) {
  ...
  const qaDataMutation = useMutation(({ id, data }) => updateQaData(id, data), {
    onSuccess() {
  ...
  const handleSubmit = async (data) => {
    ...
    qaDataMutation.mutate({ id: row.qaDatum.id, data });
    // console.log(row.qaDatum.id, typeof row.qaDatum.id,  data)
  };
          ...
          >
            <VStack width={{ base: '100%', md: '250px' }} spacing={3} mb={6}>
              <FormControl isInvalid={errors.moistureContent}>
                ...
                <Input
                  ...
                  defaultValue={row.qaDatum.moistureContent}
                />
                <FormErrorMessage>
              ...
              <FormControl isInvalid={errors.coloration}>
                ...
                <Input
                  sx={inputFieldStyles}
                  {...register('coloration')}
                  defaultValue={row.qaDatum.coloration}
                />
                <FormErrorMessage>
            ...
            <VStack width={{ base: '100%', md: '250px' }} spacing={3} mb={6}>
              <FormControl isInvalid={errors.insectOrvermin}>
                ...
                <Input
                  sx={inputFieldStyles}
                  {...register('insectOrvermin')}
                  defaultValue={row.qaDatum.insectOrvermin}
                />
                <FormErrorMessage>
              ...
              <FormControl isInvalid={errors.brokenGrain}>
                ...
                <Input
                  ...
                  defaultValue={row.qaDatum.brokenGrain}
                />
                <FormErrorMessage>
              ...
              <FormControl isInvalid={errors.immatureShrivelled}>
                ...
                <Input
                  ...
                  defaultValue={row.qaDatum.immatureShrivelled}
                />
                <FormErrorMessage>
              ...
              <FormControl isInvalid={errors.rottenOrDiseased}>
                ...
                <Input
                  ...
                  defaultValue={row.qaDatum.rottenOrDiseased}
                />
                <FormErrorMessage>
              ...
              <FormControl isInvalid={errors.organicMatter}>
                ...
                <Input
                  ...
                  defaultValue={row.qaDatum.organicMatter}
                />
                <FormErrorMessage>
            ...
            <VStack width={{ base: '100%', md: '250px' }} spacing={3} mb={6}>
              <FormControl isInvalid={errors.inorganicMatter}>
                ...
                <Input
                  sx={inputFieldStyles}
                  {...register('inorganicMatter')}
                  defaultValue={row.qaDatum.inorganicMatter}
                />
                <FormErrorMessage>
              ...
              <FormControl isInvalid={errors.filth}>
                ...
                <Input
                  sx={inputFieldStyles}
                  {...register('filth')}
                  defaultValue={row.qaDatum.filth}
                />
              ...
              <FormControl isInvalid={errors.contrastingVarieties}>
                ...
                <Input
                  ...
                  defaultValue={row.qaDatum.contrastingVarieties}
                />
                <FormErrorMessage>
              ...
              <FormControl isInvalid={errors.pesticideResidues}>
                ...
                <Input
                  ...
                  defaultValue={row.qaDatum.pesticideResidues}
                />
                <FormErrorMessage>
              ...
              <FormControl isInvalid={errors.heatDamaged}>
                ...
                <Input
                  sx={inputFieldStyles}
                  {...register('heatDamaged')}
                  defaultValue={row.qaDatum.heatDamaged}
                />
                <FormErrorMessage>
